...
| 2 — Feature Engineering | `docs/ai/tasks/stage2_features.md` | `pipeline/stage2_features.py` | Not started |
| 3 — Model Training | `docs/ai/tasks/stage3_train.md` | `pipeline/stage3_train.py` | Not started |
