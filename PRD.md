...
- Surface results through a dashboard with three views: league analytics, backtest performance, and an odds inspector
...
│                       DASHBOARD                                 │
│  Flask + HTML/CSS/JS                                            │
│  Tab 1: League Analytics  |  Tab 2: Backtest  |  Tab 3: Odds    │
└─────────────────────────────────────────────────────────────────┘
```
...
│   ├── FRA/
│   ├── SPA/
│   └── processed/               # Parquet output from Stage 1
├── pipeline/
│   ├── stage1_ingest.py         # PySpark merge + clean
│   ├── stage2_features.py       # Feature engineering
│   ├── stage3_train.py          # Model training + MLflow logging
│   ├── stage4_odds_gen.py       # Probability → implied odds
│   ├── stage5_compare.py        # Odds API fetch + value bet flagging
...
| Dashboard loads all three tabs without error | Required |
