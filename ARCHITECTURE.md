...
The pipeline is composed of six independent stages. Each stage has a defined input and output. Stages communicate exclusively through files — no stage calls another stage's code directly. This means any stage can be rerun, replaced, or debugged in isolation.
...
│   ├── stage5_compare.py           # Odds API + value bet flagging
